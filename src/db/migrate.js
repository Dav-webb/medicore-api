/**
 * MediCore AI — Schema Migration (Railway / cloud-safe)
 * Uses DATABASE_URL if set, otherwise falls back to individual env vars.
 * Does NOT try to CREATE DATABASE — the DB must already exist.
 */
